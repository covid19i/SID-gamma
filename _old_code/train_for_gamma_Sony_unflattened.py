...
checkpoint_dir = './all_of_gt_Sony_GPU_efficient/'
result_dir = './all_of_gt_Sony_GPU_efficient/'
...
def network(input):
    ...
    #print(out.shape)
    #(?,)
    out = slim.fully_connected(out, 1, scope='fc_1')#Nx32x32x12 input
...
G_loss = tf.reduce_mean(tf.abs(out_gamma - gt_gamma))
