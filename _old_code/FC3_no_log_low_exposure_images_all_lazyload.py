...
checkpoint_dir = './gt_Sony_FC3_exposure_lazyload_run5/'
...
if DEBUG == 1:
    ...
    train_ids = train_ids[0:limit]
    train_fns = train_fns[0:limit]
    train_exposures = train_exposures[0:limit]
...
for epoch in range(lastepoch, final_epoch):
    ...
    if((epoch - lastepoch) % 2 == 1 or (epoch - lastepoch) < 5):
