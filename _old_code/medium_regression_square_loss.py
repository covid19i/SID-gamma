...
checkpoint_dir = './gt_Sony_medium_scaled_regression_MSE_lowerLRat1000/'
result_dir = './gt_Sony_medium_scaled_regression_MSE_lowerLRat1000/'
...
print("Scaling the regression labels now.")
...
for epoch in range(lastepoch, final_epoch):
    ...
    for i in range(no_of_batches):
        ...
        assigned_image_gamma = 1/300 * assigned_image_gamma#scaling for the sake of Neural Network training
