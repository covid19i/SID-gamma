...
checkpoint_dir = './all_of_gt_Sony_GPU_efficient_flattened_1output/'
result_dir = './all_of_gt_Sony_GPU_efficient_flattened_1output/'
...
G_loss = tf.reduce_mean(tf.abs(out_gamma - tf.dtypes.cast(tf.squeeze(gt_gamma), tf.float32)))
